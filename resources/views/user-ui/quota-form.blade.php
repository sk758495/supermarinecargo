...
<body>
    ...
    <div class="container py-5">
        <div class="card p-4">
            ...
            <form method="POST" action="{{ route('quota.store', ['vendor_id' => $vendor->id]) }}"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="voyage_number"
                                placeholder="Enter Voyage Number" required>
                        </div>
                        <div class="col-md-6">
                            <label>IMO Number</label>
                            <input type="text" class="form-control" name="imo_number" placeholder="Enter IMO Number"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label>ETA</label>
                        ...
                        <div class="col-md-6">
                            <label>Agents</label>
                            <input type="text" class="form-control" name="agents" placeholder="Enter Agent Name"
                                required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="service_description" rows="3" placeholder="Describe the service needed"
                                required></textarea>
                        </div>
                        <div class="col-12">
                            <label>TOB Cleaning</label>
                            <input type="text" class="form-control" name="tob_cleaning"
                                placeholder="Enter TOB Cleaning Details" required>
                        </div>
                        <div class="col-12">
                            <label>Equipment Description</label>
                            <textarea class="form-control" name="equipment_description" rows="2" placeholder="Describe the equipment if any"
                                required></textarea>
                        </div>
                        <div class="col-12">
                ...
                <div class="form-section">
                    ...
                    <div class="image-upload-section">
                        ...
                        <input type="file" class="form-control" name="hold_images[1][]" multiple
                            onchange="previewImages(event, 'preview1')" required>
                    ...
                    <div class="image-upload-section">
                        ...
                        <input type="file" class="form-control" name="hold_images[2][]" multiple
                            onchange="previewImages(event, 'preview2')" required>
                    ...
                    <div class="image-upload-section">
                        ...
                        <input type="file" class="form-control" name="hold_images[3][]" multiple
                            onchange="previewImages(event, 'preview3')" required>
                    ...
                    <div class="image-upload-section">
                        ...
                        <input type="file" class="form-control" name="hold_images[4][]" multiple
                            onchange="previewImages(event, 'preview4')" required>
                    ...
                    <div class="image-upload-section">
                        ...
                        <input type="file" class="form-control" name="hold_images[5][]" multiple
                            onchange="previewImages(event, 'preview5')" required>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="company_name"
                                placeholder="Techno Web 4 Design" required>
                        </div>
                        <div class="col-md-6">
    ...
    <script>
        function previewImages(event, previewId) {
            ...
            const errorContainer = document.getElementById(previewId + 'Error');
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                // Preview the image (no size or count validation)
